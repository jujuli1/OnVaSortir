 ...
 */
final class Version20260114152003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD birthday DATETIME NOT NULL, ADD telephone VARCHAR(10) DEFAULT NULL');
