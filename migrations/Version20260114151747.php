 ...
 */
final class Version20260114151747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE campus DROP adresse');
        $this->addSql('ALTER TABLE campus ADD CONSTRAINT FK_9D096811A73F0036 FOREIGN KEY (ville_id) REFERENCES ville (id)');
        $this->addSql('ALTER TABLE inscription ADD date_inscription DATETIME NOT NULL, ADD status_inscription TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE campus ADD adresse VARCHAR(20) NOT NULL');
        ...
        $this->addSql('ALTER TABLE inscription DROP date_inscription, DROP status_inscription');
        $this->addSql('ALTER TABLE sortie DROP FOREIGN KEY FK_3C3FD3F2FB88E14F');
        $this->addSql('ALTER TABLE sortie ADD status TINYINT NOT NULL');
        $this->addSql('ALTER TABLE utilisateur DROP FOREIGN KEY FK_1D1C63B3AF5D55E1');
        $this->addSql('ALTER TABLE utilisateur ADD birthday DATETIME DEFAULT NULL, ADD telephone VARCHAR(10) DEFAULT NULL');
        $this->addSql('ALTER TABLE ville ADD code_postal VARCHAR(5) NOT NULL');
    }
}
